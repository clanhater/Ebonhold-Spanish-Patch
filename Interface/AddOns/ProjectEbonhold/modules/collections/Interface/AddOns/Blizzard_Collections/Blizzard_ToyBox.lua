...
function ToyBox_OnShow(self)
	...
	SetPortraitToTexture(CollectionsJournalPortrait, [[Interface\AddOns\ProjectEbonhold\modules\collections\Interface\Icons\Trade_Archaeology_ChestofTinyGlassAnimals]]);
