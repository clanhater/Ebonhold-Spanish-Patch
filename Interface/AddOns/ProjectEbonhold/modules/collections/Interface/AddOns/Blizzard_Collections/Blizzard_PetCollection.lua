...
function GetPetTypeTexture(petType)
	if PET_TYPE_SUFFIX[petType] then
		return [[Interface\AddOns\ProjectEbonhold\modules\collections\Interface\PetBattles\PetIcon-]]..PET_TYPE_SUFFIX[petType];
	else
		return [[Interface\AddOns\ProjectEbonhold\modules\collections\Interface\PetBattles\PetIcon-NO_TYPE]];
	end
end
...
function PetJournal_UpdatePetDisplay()
	if ( PetJournal.selectedPetID ) then
		...
		PetJournal.TypeInfo.typeIcon:SetTexture([[Interface\AddOns\ProjectEbonhold\modules\collections\Interface\PetBattles\PetIcon-]]..PET_TYPE_SUFFIX[petType]);
