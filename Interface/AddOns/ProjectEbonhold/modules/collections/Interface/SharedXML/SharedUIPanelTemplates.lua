...
function MagicButton_OnLoad(self)
	...
	for i=1, self:GetNumPoints() do
		...
		if (relativeTo:GetObjectType() == "Button" and (point == "TOPLEFT" or point == "LEFT")) then
			...
			self.LeftSeparator:SetTexture([[Interface\AddOns\ProjectEbonhold\modules\collections\Interface\FrameGeneral\UI-Frame]]);
		...
		elseif (relativeTo:GetObjectType() == "Button" and (point == "TOPRIGHT" or point == "RIGHT")) then
			...
			self.RightSeparator:SetTexture([[Interface\AddOns\ProjectEbonhold\modules\collections\Interface\\FrameGeneral\\UI-Frame]]);
